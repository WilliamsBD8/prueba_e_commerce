...
@Service
public class UpdateOrderBackStateUseCase {
    private final OrderRepositoryPort orderRepository;
    private final InventoryService inventoryService;
    private final OrderEventPublisherPort orderEventPublisher; 

    public UpdateOrderBackStateUseCase(OrderRepositoryPort orderRepository, InventoryService inventoryService, OrderEventPublisherPort orderEventPublisher) {
